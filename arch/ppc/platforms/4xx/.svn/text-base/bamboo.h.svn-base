...
/* Flash */
#define BAMBOO_SMALL_FLASH_LOW		0x87f00000UL
#define BAMBOO_SMALL_FLASH_HIGH		0xfff00000UL
#define BAMBOO_SMALL_FLASH_SIZE		0x100000
#define BAMBOO_LARGE_FLASH_LOW		0x87800000UL
#define BAMBOO_LARGE_FLASH_LOW1		0x87800000UL
#define BAMBOO_LARGE_FLASH_LOW2		0x87c00000UL
#define BAMBOO_LARGE_FLASH_HIGH1	0xff800000UL
#define BAMBOO_LARGE_FLASH_HIGH2	0xffc00000UL
#define BAMBOO_LARGE_FLASH_SIZE		0x400000
#define BAMBOO_SRAM_LOW			0x87f00000UL
#define BAMBOO_SRAM_LOW1		0x87f00000UL
#define BAMBOO_SRAM_LOW2		0x87b00000UL
#define BAMBOO_SRAM_HIGH1		0xfff00000UL
#define BAMBOO_SRAM_HIGH2		0xff800000UL
#define BAMBOO_SRAM_SIZE		0x100000
#define BAMBOO_NAND_FLASH_REG_ADDR	0x90000000UL
